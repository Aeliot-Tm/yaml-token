...
final class Lexer
{
    ...
    /**
     * Split `%TAG` lines into `TAG_DIRECTIVE`, `DIRECTIVE_TAG_HANDLE`, `DIRECTIVE_TAG_PREFIX` only when the keyword
    ...
    private function tokenizeTagDirectiveLine(Harvester $harvester): void
    {
        ...
        $harvester->stream->addToken(new Token(TokenType::TAG_DIRECTIVE, '%TAG', $directiveTagLine, $directiveTagColumn));
    ...
    private function tokenizeYamlDirectiveLine(Harvester $harvester): void
    {
        ...
        $harvester->stream->addToken(new Token(TokenType::YAML_DIRECTIVE, '%YAML', $directiveYamlLine, $directiveYamlColumn));
