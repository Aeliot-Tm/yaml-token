...
final class LexerMappingTagVerbatimTest extends LexerMappingTestCase
{
    public static function getDataForTestMapping(): iterable
    {
        yield [[
            ...
            [
                'type' => TokenType::TAG_VERBATIM_INDICATOR,
                'text' => '!',
            ],
            [
                'type' => TokenType::TAG_VERBATIM_OPEN,
                'text' => '<',
            ],
            [
            ...
            [
                'type' => TokenType::TAG_VERBATIM_CLOSE,
                'text' => '>',
            ],
            [
...
',
        ...
        ], __DIR__.'/../../../../fixture/spec/1.2.0/tag-verbatim_6.9.1.yaml'];
    }
}
