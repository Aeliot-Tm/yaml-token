...
final class MappingBlockScalarStripEdgeCasesTest extends LexerMappingTestCase
{
    public static function getDataForTestMapping(): iterable
    {
        ...
        ], __DIR__.'/../../../../fixture/spec/1.2.2/folded-strip-indented-empty-tail_8.1.3.yaml'];
        ...
        ], __DIR__.'/../../../../fixture/spec/1.2.2/folded-strip-then-sibling-key_8.1.3.yaml'];
    }
}
