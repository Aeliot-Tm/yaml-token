...
final class BareDocumentAfterDocumentEndMarkerTest extends LexerMappingTestCase
{
    public static function getDataForTestMapping(): iterable
    {
        ...
        ], __DIR__.'/../../../fixture/edge_cases_extra/bare_document_after_document_end_marker.yaml'];
    }
}
