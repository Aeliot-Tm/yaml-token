...
final class LexerJsonInPlainScalarOfMappingTest extends LexerMappingTestCase
{
    public static function getDataForTestMapping(): iterable
    {
        ...
        ], __DIR__.'/../../../../fixture/edge_cases/indentation/json_in_plain_scalar_of_mapping.yaml'];
    }
}
