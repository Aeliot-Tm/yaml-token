...
final class LexerColonFollowedByHashInPlainScalarTest extends LexerMappingTestCase
{
    public static function getDataForTestMapping(): iterable
    {
        ...
        ], __DIR__.'/../../../fixture/edge_cases/colon_followed_by_hash_in_plain_scalar.yaml'];
    }
}
