...
final class AllowedCharactersInQuotedMappingKeyTest extends LexerMappingTestCase
{
    public static function getDataForTestMapping(): iterable
    {
        ...
        ], __DIR__.'/../../../fixture/edge_cases/allowed_characters_in_quoted_mapping_key.yaml'];
    }
}
