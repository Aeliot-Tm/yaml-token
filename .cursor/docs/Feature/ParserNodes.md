...
| `YamlDirectiveVersionNode` | `DIRECTIVE_YAML_VERSION` (version string) |
...
| `getVersionNode()` | `?YamlDirectiveVersionNode` |
...
| Method | Returns |
|--------|---------|
| `getIndicatorNode()` | `?TagDirectiveIndicatorNode` |
| `getHandleNode()` | `?TagDirectiveHandleNode` |
